...
const (
	updateUrl    = "https://github.com/lvlvshan/octopus-plus/releases/latest/download"
	updateApiUrl = "https://api.github.com/repos/lvlvshan/octopus-plus/releases/latest"
)
